            ...
            <div class="event_content mb-40">
                <div class="row justify-content-center">
                    ...
                    <div class="form-group">
                      <input class="form-control" id="amount" type="text" name="amount" placeholder="Donation Amount">
                    </div>
                    <div class="form-group mt-2 mb-5 mb-lg-0">

                      <button type="submit" class="button button-contactForm primary-btn">Donation with Esewa</button>
