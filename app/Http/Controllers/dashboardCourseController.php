...
class dashboardCauseController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        return view('dashboard.dashboardCourse.index',compact('Causes'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.dashboardCourse.create',compact('Categores'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('image')){  
          ...
          $Cause->save();
                ...
                return redirect()->TO('dashboard/dashboardCourse')
    ...
    public function edit($slug)
    {
        ...
        $Categores = Category::all();
        return view('dashboard.dashboardCourse.edit',compact('Course','Categores'));
    }
